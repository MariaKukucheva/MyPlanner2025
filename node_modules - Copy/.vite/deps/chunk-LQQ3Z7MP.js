...
} from "./chunk-XWHL3PQM.js";
import {
  MuiPickersAdapterContext
} from "./chunk-MLVBQ5DY.js";
import {
  useThemeProps
} from "./chunk-NEG2JKBQ.js";
import {
  IconButton_default
} from "./chunk-2JWUWXND.js";
import {
  useTimeout
} from "./chunk-5ZIVWL3M.js";
import {
...
function useApplyDefaultValuesToDateFieldInternalProps(internalProps) {
  ...
  return React8.useMemo(() => _extends({}, internalProps, validationProps, {
...
function useApplyDefaultValuesToTimeFieldInternalProps(internalProps) {
  ...
  const ampm = React9.useMemo(() => internalProps.ampm ?? utils.is12HourCycleInCurrentLocale(), [internalProps.ampm, utils]);
...
var PickersLayout = React14.forwardRef(function PickersLayout2(inProps, ref) {
  ...
  return (0, import_jsx_runtime5.jsxs)(PickersLayoutRoot, {
    ...
    children: [orientation === "landscape" ? shortcuts : toolbar, orientation === "landscape" ? toolbar : shortcuts, (0, import_jsx_runtime5.jsx)(PickersLayoutContentWrapper, {
      ...
      ownerState,
      children: variant === "desktop" ? (0, import_jsx_runtime5.jsxs)(React14.Fragment, {
...
function useMeridiemMode(date, ampm, onChange, selectionState) {
  const utils = useUtils();
  const cleanDate = React17.useMemo(() => !utils.isValid(date) ? null : date, [utils, date]);
...
var useFieldState = (parameters) => {
  ...
  const getSectionsFromValue = React19.useCallback((valueToAnalyze) => fieldValueManager.getSectionsFromValue(valueToAnalyze, (date) => buildSectionsFromFormat({
    utils,
    localeText: translations,
    localizedDigits,
    format,
  ...
  const areAllSectionsEmpty = React19.useMemo(() => state.sections.every((section) => section.value === ""), [state.sections]);
  ...
  const sectionToUpdateOnNextInvalidDateRef = React19.useRef(null);
...
function useFieldInternalPropsWithDefaults(parameters) {
  ...
  const handleChangeFromPicker = React20.useCallback((newValue, ctx) => {
    return setValue == null ? void 0 : setValue(newValue, {
      validationError: ctx.validationError,
      shouldClose: false
    });
  }, [setValue]);
  const internalPropsWithDefaultsFromContext = React20.useMemo(() => {
...
function useFieldSectionContainerProps(parameters) {
  ...
  const createHandleClick = React22.useCallback((sectionIndex) => (event) => {
    if (disabled || event.isDefaultPrevented()) {
      return;
    }
    setSelectedSections(sectionIndex);
  }, [disabled, setSelectedSections]);
  return React22.useCallback((sectionIndex) => ({
...
var _excluded6 = ["enableAccessibleFieldDOMStructure"];
...
var cleanFieldResponse = (_ref) => {
  let {
    enableAccessibleFieldDOMStructure
  } = _ref, fieldResponse = _objectWithoutPropertiesLoose(_ref, _excluded6);
...
var PickerFieldUIContext = React26.createContext({
  slots: {},
  slotProps: {},
  inputRef: void 0
});
...
function PickerFieldUI(props) {
  ...
  const translations = usePickerTranslations();
  const pickerContext = useNullablePickerContext();
  const pickerFieldUIContext = React26.useContext(PickerFieldUIContext);
  const {
    textFieldProps,
    onClear,
    clearable,
  ...
  if (!((_a = textFieldProps.InputProps) == null ? void 0 : _a.startAdornment) && (clearButtonPosition === "start" || openPickerButtonPosition === "start")) {
    textFieldProps.InputProps.startAdornment = (0, import_jsx_runtime7.jsxs)(InputAdornment, _extends({}, startInputAdornmentProps, {
      children: [openPickerButtonPosition === "start" && (0, import_jsx_runtime7.jsx)(OpenPickerButton, _extends({}, openPickerButtonProps, {
        children: (0, import_jsx_runtime7.jsx)(OpenPickerIcon, _extends({}, openPickerIconProps))
      })), clearButtonPosition === "start" && (0, import_jsx_runtime7.jsx)(ClearButton, _extends({}, clearButtonProps, {
        children: (0, import_jsx_runtime7.jsx)(ClearIcon2, _extends({}, clearIconProps))
      }))]
    }));
  }
  if (!((_b = textFieldProps.InputProps) == null ? void 0 : _b.endAdornment) && (clearButtonPosition === "end" || openPickerButtonPosition === "end")) {
    textFieldProps.InputProps.endAdornment = (0, import_jsx_runtime7.jsxs)(InputAdornment, _extends({}, endInputAdornmentProps, {
      children: [clearButtonPosition === "end" && (0, import_jsx_runtime7.jsx)(ClearButton, _extends({}, clearButtonProps, {
        children: (0, import_jsx_runtime7.jsx)(ClearIcon2, _extends({}, clearIconProps))
      })), openPickerButtonPosition === "end" && (0, import_jsx_runtime7.jsx)(OpenPickerButton, _extends({}, openPickerButtonProps, {
        children: (0, import_jsx_runtime7.jsx)(OpenPickerIcon, _extends({}, openPickerIconProps))
      }))]
    }));
  }
  ...
  return (0, import_jsx_runtime7.jsx)(TextField, _extends({}, textFieldProps));
}
...
function PickerFieldUIContextProvider(props) {
  ...
  return (0, import_jsx_runtime7.jsx)(PickerFieldUIContext.Provider, {
    value: contextValue,
    children
  });
}
...
var _excluded9 = ["children", "className", "classes", "toolbarTitle", "hidden", "titleId", "classes", "landscapeDirection"];
...
var _excluded10 = ["PaperComponent", "ownerState", "children", "paperSlotProps", "paperClasses", "onPaperClick", "onPaperTouchStart"];
...
var PickerPopperPaperWrapper = React29.forwardRef((props, ref) => {
  const {
    PaperComponent,
    ownerState,
    children,
  ...
  return (0, import_jsx_runtime9.jsx)(Popper, _extends({}, popperProps, {
    children: ({
      ...
      children: (0, import_jsx_runtime9.jsx)(Transition, _extends({}, TransitionProps, slotProps == null ? void 0 : slotProps.desktopTransition, {
        ...
        children: (0, import_jsx_runtime9.jsx)(PickerPopperPaperWrapper, {
...
function useValueAndOpenStates(parameters) {
  ...
  } = React31.useRef(defaultValueProp);
  const {
    current: isValueControlled
  } = React31.useRef(valueProp !== void 0);
  const {
    current: isOpenControlled
  } = React31.useRef(openProp !== void 0);
  const utils = useUtils();
  if (true) {
  ...
  const viewValue = React31.useMemo(() => valueManager.cleanValue(utils, state.clockShallowValue === void 0 ? value : state.clockShallowValue), [utils, valueManager, state.clockShallowValue, value]);
  return {
    timezone,
    state,
    setValue,
...
var usePicker = ({
  ...
  const {
    className,
    sx
  } = props, propsToForwardToView = _objectWithoutPropertiesLoose(props, _excluded11);
  const labelId = useId();
  const utils = useUtils();
  const adapter = useLocalizationContext();
  ...
  const {
    current: initialView
  } = React32.useRef(openTo ?? null);
  const [triggerElement, triggerRef] = React32.useState(null);
  const popupRef = React32.useRef(null);
  const fieldRef = React32.useRef(null);
  const rootRefObject = React32.useRef(null);
  ...
  const ownerState = React32.useMemo(() => ({
  ...
  const triggerStatus = React32.useMemo(() => {
  ...
  const contextValue = React32.useMemo(() => _extends({}, actionsContextValue, {
    value,
    timezone,
    open: state.open,
    views,
  ...
  const privateContextValue = React32.useMemo(() => ({
    dismissViews,
    ownerState,
    hasUIView,
    getCurrentViewMode,
  ...
  const fieldPrivateContextValue = React32.useMemo(() => ({
    formatDensity,
    enableAccessibleFieldDOMStructure,
    selectedSections,
    onSelectedSectionsChange,
  ...
  const renderCurrentView = () => {
    ...
    if (RendererInterceptor) {
      return (0, import_jsx_runtime10.jsx)(RendererInterceptor, {
        viewRenderers,
        popperView,
        rendererProps
      });
...
var useMobilePicker = (_ref) => {
  ...
  const _useSlotProps = useSlotProps_default({
    ...
    ownerState
  }), fieldProps = _objectWithoutPropertiesLoose(_useSlotProps, _excluded26);
  const Layout = slots.layout ?? PickersLayout;
  let labelledById = labelId;
  if (isToolbarHidden) {
    if (label) {
  ...
  const renderPicker = () => (0, import_jsx_runtime13.jsx)(PickerProvider, _extends({}, providerProps, {
    children: (0, import_jsx_runtime13.jsxs)(PickerFieldUIContextProvider, {
      slots,
      slotProps,
      inputRef,
      children: [(0, import_jsx_runtime13.jsx)(Field, _extends({}, fieldProps)), (0, import_jsx_runtime13.jsx)(PickersModalDialog, {
        slots,
        slotProps,
...
//# sourceMappingURL=chunk-LQQ3Z7MP.js.map
